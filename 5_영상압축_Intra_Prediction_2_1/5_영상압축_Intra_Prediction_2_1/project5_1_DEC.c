...
int main() {
    ...
    FILE* wf_e = NULL;
    FILE* wf_r = NULL;
    FILE* text = fopen("5_1_bitstream.txt", "rb");

    rf = fopen("../../FOREMAN_CIF30.yuv", "rb");
    //wf_p = fopen("FOREMAN_CIF30_PRED_DC.yuv", "wb");
    //wf_e = fopen("FOREMAN_CIF30_ERROR_DC.yuv", "wb");
    wf_r = fopen("5_1_FOREMAN_CIF30_RECON_DC_DEC.yuv", "wb");
    ...
    int* er = (int*)malloc(sizeof(int) * 3);
